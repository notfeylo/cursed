; NSIS hooks for the CursorForge installer.
;
...
!macro NSIS_HOOK_PREINSTALL
  ; Nothing to do. CursorForge installs per-user and touches no shared state.
!macroend
...
!macro NSIS_HOOK_POSTUNINSTALL
  ...
  RMDir /r "$APPDATA\CursorForge\cache"
  ; Presets, custom cursors and settings are the user's own work and are left
  ; in place. `%APPDATA%\CursorForge` can be deleted by hand if they want it
